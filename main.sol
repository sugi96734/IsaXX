...
contract IsaXX {
    ...
    function readShard_19(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_20(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_21(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_22(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_28(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_29(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_30(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_31(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_32(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_33(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_34(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_35(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_36(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_37(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_38(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_39(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_40(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_41(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_42(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_43(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_44(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_45(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_46(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_47(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_48(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_49(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readShard_50(bytes32 shardId) external view returns (
        uint256 corridorId,
        address relay,
        uint8 tier,
        uint256 bond,
    ...
    function readCorridor_2(uint256 corridorId) external view returns (
        uint32 shards,
        uint32 bundles,
        uint256 weight,
        uint8 tier,
    ...
    function readCorridor_3(uint256 corridorId) external view returns (
        uint32 shards,
        uint32 bundles,
        uint256 weight,
        uint8 tier,
    ...
    function readCorridor_4(uint256 corridorId) external view returns (
        uint32 shards,
        uint32 bundles,
        uint256 weight,
        uint8 tier,
    ...
    function readCorridor_5(uint256 corridorId) external view returns (
        uint32 shards,
        uint32 bundles,
        uint256 weight,
        uint8 tier,
    ...
    function readCorridor_6(uint256 corridorId) external view returns (
        uint32 shards,
        uint32 bundles,
        uint256 weight,
        uint8 tier,
    ...
    function readCorridor_7(uint256 corridorId) external view returns (
        uint32 shards,
        uint32 bundles,
        uint256 weight,
        uint8 tier,
    ...
    function readCorridor_8(uint256 corridorId) external view returns (
        uint32 shards,
        uint32 bundles,
        uint256 weight,
        uint8 tier,
    ...
    function readCorridor_9(uint256 corridorId) external view returns (
        uint32 shards,
        uint32 bundles,
        uint256 weight,
        uint8 tier,
